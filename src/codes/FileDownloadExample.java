...
public class FileDownloadExample
{
    ...
    public static FirefoxProfile FirefoxDriverProfile() throws Exception
    {
        ...
        profile.setPreference("browser.helperApps.neverAsk.openFile","text/csv,application/x-msexcel,application/excel,application/x-excel,application/vnd.msexcel,image/png,image/jpeg,text/html,text/plain,application/msword,application/xml");
